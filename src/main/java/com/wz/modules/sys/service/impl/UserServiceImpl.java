...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public String resetPassword(String loginName, String phoneNumber) {
        UserEntity userEntity = userDao.queryByLoginNameAndPhone(loginName, phoneNumber);
        if (userEntity == null) {
            return null;
        }
        // 生成salt
        ...
        params.put("passWord", ShiroUtils.EncodeSalt(newPassword, salt));
        int result = userDao.resetOnePassWord(params);
        return newPassword;
    }
    ...
    public String findBapid(String organId) {
        ...
        if (organEntity != null && (Constant.OrganType.ORGAN.getValue().equals(organEntity.getType())
                || Constant.OrganType.CATALOG.getValue().equals(organEntity.getType()))) {
    ...
    public List<UserEntity> queryObjectByRole() {
        return userDao.queryObjectByRole();
    }

    public List<UserEntity> queryUserProjectRel(String projectId) {
        return userDao.queryUserProjectRel(projectId);
    }

    public List<RoleEntity> queryRoleUser() {
        return userDao.queryRoleUser();
    }
}