package com.wz.modules.common.common;
...
public class Constant {
    ...
    public static String KK_AUTH_URL="http://open.snd02.com/oauth/authorize.as";
    public static String KK_INTER_URL="http://open.snd02.com/invoke/router.as";
    public static String KK_CLIENT_ID = "O000000044";
    public static String KK_REDIRECT_URL="http://open.snd02.com/demo.jsp";
    public static String KK_USNER_NAME="lin001";
    public static String KK_PASSWORD="lin888888";
    public static String KK_PROJECT_CODE="P00000000268";
    public static String KK_APP_SECRET="749A98BC2D17883E54B083ECBC8D39FC";
    public static String KK_REFRESH_TOKEN="";
    public static String KK_ACCESS_TOKEN="";
}
