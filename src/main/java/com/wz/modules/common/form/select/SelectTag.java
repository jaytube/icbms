package com.wz.modules.common.form.select;
...
public class SelectTag extends SimpleTagSupport {
    ...
    private static RedisUtil redisutils = SpringContextUtils.getBean(RedisUtil.class);
...
//                    Map<String,Map<String,Object>> allCodeMap= CodeCache.get(Constant.CODE_CACHE);
					Map<String,Map<String,Object>> allCodeMap= (Map<String, Map<String, Object>>) buildRedisUtils().getObject(Constant.CODE_CACHE);
                    //获取mark=nameKey的字典
