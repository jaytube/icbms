- [终端发送数据包格式](#终端发送数据包格式)
  - [举例分析](#举例分析)
    - [例一实时数据-数据解析](#例一实时数据-数据解析)
      - [例一实时数据其中data-数据解析](#例一实时数据其中data-数据解析)
    - [例二获取服务器时间-数据解析](#例二获取服务器时间-数据解析)
    - [例三返回服务器时间响应-数据解析](#例三返回服务器时间响应-数据解析)
    - [例四控制合分闸命令-数据解析](#例四控制合分闸命令-数据解析)
    - [例五读取门限参数命令-数据解析](#例五读取门限参数命令-数据解析)
    - [例六设置门限参数命令-数据解析](#例六设置门限参数命令-数据解析)
# 终端发送数据包格式
